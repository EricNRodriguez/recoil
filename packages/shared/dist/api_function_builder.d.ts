declare type F<Args extends unknown[], ReturnType> = (
  ...args: [...Args]
) => ReturnType;
/**
 * A generic higher order function
 */
export declare type FunctionDecorator<Args extends unknown[], ReturnType> = (
...
export declare class DecoratableApiFunctionBuilder {
   ...
   */
  build<Args extends unknown[], ReturnType>(
   ...
   */
  registerDecorator<Args extends unknown[], ReturnType>(
   ...
   */
  deregisterDecorator<Args extends unknown[], ReturnType>(
    apiFn: F<Args, ReturnType>,
    decorator: FunctionDecorator<Args, ReturnType>
  ): void;
  /**
